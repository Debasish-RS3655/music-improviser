...
def createMusicXML(midiPath, new_musicxml_path):
	os.system('"C:/Program Files/MuseScore 3/bin/MuseScore3.exe" '+ midiPath +" -o " + new_musicxml_path)
	#os.system("set QT_QPA_PLATFORM=offscreen && musescore "+ midiPath +" -o " + new_musicxml_path)
